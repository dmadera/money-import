...
SELECT DISTINCT
	...
	FORMAT(Cena.Cena, '0.00') AS ProdCena,
	...
	SUBSTRING(Dod.Kod, 4, 100) AS CisloDodavatele,
	''
...
LEFT JOIN Artikly_ArtiklDodavatel AS ArtDod ON ArtDod.ID = A.HlavniDodavatel_ID
LEFT JOIN Adresar_Firma AS Dod ON Dod.ID = ArtDod.Firma_ID
WHERE 
